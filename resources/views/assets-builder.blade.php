        ...
        <div id="component1" class="component" data-astro-cid-ujfssy6h>
            <div class="flex w-full flex-col gap-6 mt-6">
                ...
                <div class="flex flex-col gap-1">
                    ...
                    <p class="font-normal text-3xl">Facebook Feed</p>
                </div>
                                    ...
                                    <div class="w-full">
                                        <div class="w-full flex flex-col gap-3">
                                            ...
                                            <textarea onkeydown="AddInfoToPreview({{ $num }})" id="primary-input-{{ $num }}"
                                                ...
                                                {{-- placeholder="Placeholder Text..." maxlength="125">{{ $Asset->AssetParameters->primary_text ?? '' }}</textarea> --}} placeholder="Placeholder Text..." maxlength="125"></textarea>
                                            ...
                                            <div class="flex justify-between w-full">
                                                ...
                                                <div class="flex items-center">
                                                    ...
                                                    <input type="checkbox" id="checkbox" value="1"
                                                        {{-- {{ optional($Asset->AssetParameters)->link_description != null ? 'checked' : '' }} --}} name="LinkDescription[{{ $num }}]"
                                                        class="form-checkbox checked:bg-[#ea33c0]">
                                                </div>
                                            </div>
