                        ...
                        <div class="flex flex-col gap-2" data-astro-cid-ih4xnkm6>
                            ...
                            <div class="flex gap-1" data-astro-cid-ih4xnkm6>
                                ...
                                @foreach ($Campaigns->Flight as $Flight)
                                    <a href="#" class="badge bg-[#dddddd] p-3 text-sm">
                    ...
                    <div class="flex flex-col gap-2" data-astro-cid-ih4xnkm6>
                        ...
                        <div class="flex gap-2 items-center" data-astro-cid-ih4xnkm6>
                            ...
                            <div class="w-full bg-gray-200 rounded-full h-6 relative" data-astro-cid-ih4xnkm6>
                                <progress class="w-full h-full rounded-full" value="{{ $statusCount->status_count ?? 0 }}" max="10"
                                ...
                                <div class="absolute top-0 left-0 h-full w-full rounded-full flex justify-between items-center px-3"
                                    ...
                                    <img src="/assets/icons/task_fill.png" alt="create campaign" class="w-3"
                                        data-astro-cid-ih4xnkm6 />
                                        <p data-astro-cid-ih4xnkm6>{{ $statusCount->status_count ?? 0 }}</p>
                                </div>
                            </div>
                        </div>
                        @elseif ($statusCount->status == 'progress')
                        <div class="flex gap-2 items-center" data-astro-cid-ih4xnkm6>
                            <p class="text-base font-medium w-32" data-astro-cid-ih4xnkm6>
                                In Progress 
                            </p>
                            <div class="w-full bg-gray-200 rounded-full h-6 relative" data-astro-cid-ih4xnkm6>
                                <progress class="w-full h-full rounded-full" value="{{ $statusCount->status_count}}" max="10"
                                    id="progress-2" data-astro-cid-ih4xnkm6></progress>
                                <div class="absolute top-0 left-0 h-full w-full rounded-full flex justify-between items-center px-3"
                                    data-astro-cid-ih4xnkm6>
                                    <img src="/assets/icons/emoji_objects.png" alt="create campaign" class="w-3"
                                        data-astro-cid-ih4xnkm6 />
                                        <p data-astro-cid-ih4xnkm6>{{ $statusCount->status_count}}</p>
                                </div>
                            </div>
                        </div>
                        @elseif ($statusCount->status == 'review')
                        <div class="flex gap-2 items-center" data-astro-cid-ih4xnkm6>
                            <p class="text-base font-medium w-32" data-astro-cid-ih4xnkm6>
                                In Review
                            </p>
                        ...
                        @elseif ($statusCount->status == 'approved')
                        <div class="flex gap-2 items-center" data-astro-cid-ih4xnkm6>
                            <p class="text-base font-medium w-32" data-astro-cid-ih4xnkm6>
                                Approved
                            </p>
                            <div class="w-full bg-gray-200 rounded-full h-6 relative" data-astro-cid-ih4xnkm6>
                                <progress class="w-full h-full rounded-full" value="{{ $statusCount->count }}" max="200"
                                ...
                                <div class="absolute top-0 left-0 h-full w-full rounded-full flex gap-10 items-center px-3"
                                    ...
                                    <img src="/assets/icons/check_circle.png" alt="create campaign" class="w-3"
                                        data-astro-cid-ih4xnkm6 />
                                    <p data-astro-cid-ih4xnkm6>{{ $statusCount->count }}</p>
                                </div>
                            </div>
                        </div>
                        @elseif ($statusCount->status == 'trafficking')
                        <div class="flex gap-2 items-center" data-astro-cid-ih4xnkm6>
                            <p class="text-base font-medium w-32" data-astro-cid-ih4xnkm6>
                                Trafficking
                            </p>
                        ...
                        @elseif ($statusCount->status == 'live')
                        <div class="flex gap-2 items-center" data-astro-cid-ih4xnkm6>
                            <p class="text-base font-medium w-32" data-astro-cid-ih4xnkm6>
                                Live
                            </p>
                ...
                <div class="flex flex-col w-full gap-10" data-astro-cid-iujjydvd>
                    ...
                    <div class="flex flex-col w-full gap-2">
                        ...
                        <div class="grid grid-cols-3 gap-10">
                            ...
                            <a
                                href="{{ route('assetsManage', ['id' => $Campaigns->id, 'language' => 'EN', 'type' => 'Awareness', 'flight_id' => $flightId]) }}">
                                <div class="flex flex-col w-full gap-2">
                            ...
                            <a
                                href="{{ route('assetsManage', ['id' => $Campaigns->id, 'language' => 'EN', 'type' => 'Consideration', 'flight_id' => $flightId]) }}">
                                <div class="flex flex-col w-full gap-2">
                                    <div class="flex justify-between">
                            ...
                            {{-- @if ($enCounts['Trail'] != 0) --}}
                            <a
                                href="{{ route('assetsManage', ['id' => $Campaigns->id, 'language' => 'EN', 'type' => 'Trail', 'flight_id' => $flightId]) }}">
                                <div class="flex flex-col w-full gap-2">
                                    <div class="flex justify-between">
                    ...
                    <div class="flex flex-col w-full gap-2">
                        ...
                        <div class="grid grid-cols-3 gap-10">
                            {{-- @if ($enCounts['Awareness'] != 0) --}}
                            <a
                                href="{{ route('assetsManage', ['id' => $Campaigns->id, 'language' => 'FR', 'type' => 'Awareness', 'flight_id' => $flightId]) }}">
                                <div class="flex flex-col w-full gap-2">
                                    <div class="flex justify-between">
                                        <h5 class="font-medium text-xl">Awareness</h5>
                            ...
                            {{-- @if ($enCounts['Consideration'] != 0) --}}
                            <a
                                href="{{ route('assetsManage', ['id' => $Campaigns->id, 'language' => 'FR', 'type' => 'Consideration', 'flight_id' => $flightId]) }}">
                                <div class="flex flex-col w-full gap-2">
                                    <div class="flex justify-between">
                                        <h5 class="font-medium text-xl">Consideration</h5>
                            ...
                            {{-- @if ($enCounts['Trail'] != 0) --}}
                            <a
                                href="{{ route('assetsManage', ['id' => $Campaigns->id, 'language' => 'FR', 'type' => 'Trail', 'flight_id' => $flightId]) }}">
                                <div class="flex flex-col w-full gap-2">
                                    <div class="flex justify-between">
                                        <h5 class="font-medium text-xl">Trail</h5>
