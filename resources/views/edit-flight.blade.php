                            ...
                            <div class="flex w-full gap-10 items-center" data-astro-cid-jf5gi763>
                                ...
                                <div class="flex gap-3 items-center" data-astro-cid-jf5gi763>
                                    ...
                                    <input type="hidden" required name="flightId[{{ $fligthCounter }}]"
                                        class="input input-bordered input-primary" value="{{ $Flight->id }}"
                                        data-astro-cid-jf5gi763 hidden />
                                </div>
                            </div>
                            @if (Auth::user()->role == 'Media')
                                <div data-astro-cid-jf5gi763>
                                    <button type="button" onclick="deleteFlight({{ $Flight->id }})"
                                        class="btn btn-ghost w-36 rounded-3xl" data-astro-cid-jf5gi763>
                                        Delete Flight
                                    </button>
                                </div>
                            @endif
                        ...
                        <div class="flex flex-col gap-1 w-full" data-astro-cid-jf5gi763 id="">
                            @foreach ($Flight->FlightConnection as $Connection)
                                <div class="flex relative items-start gap-4" data-astro-cid-jf5gi763>
                                    @if (Auth::user()->role == 'Media')
                                        <div onclick="deleteFlightConnection({{ $Connection->id }})"
                                            class="absolute left-[-30px] top-3" data-astro-cid-jf5gi763>
                                            <svg xmlns:xlink="http://www.w3.org/1999/xlink"
                                                xmlns="http://www.w3.org/2000/svg" width="25" onclick="removeRow(0,1)"
                                                height="25" viewBox="0 0 24 24" fill="none" data-astro-cid-jf5gi763>
                                                <path
                                    ...
                                    <div class="flex gap-3 items-center" data-astro-cid-jf5gi763>
                                        <select class="select select-primary w-[150px] rounded-md"
                                            ...
                                            id="Flight_{{ $Flight->flight_count }}_lang_0" data-astro-cid-jf5gi763
                                            required>
                                            ...
                                            <option {{ $Connection->language == 'FR' ? 'Selected' : '' }}
                                                data-astro-cid-jf5gi763>FR</option>
                                        </select>
                                        <select class="select select-primary w-[150px] rounded-md"
                                        ...
                                        <select class="select select-primary w-[150px] rounded-md"
                                            ...
                                            @foreach (\App\Models\CategoryMaster::all() as $Category)
                                                <option {{ $Connection->category_id == $Category->id ? 'Selected' : '' }}
                                                    value="{{ $Category->id }}">
                                                    {{ $Category->name }}
                                                </option>
                                            @endforeach
                                        ...
                                        <input type="hidden"
                                            ...
                                            value="{{ $Connection->id }}"
                                            class="input input-bordered input-primary min-w-36 rounded-md"
                                            placeholder="Nova Scotia<" data-astro-cid-jf5gi763 />
                                    </div>
...
>
    ...
    <div class="flex gap-3 items-center" data-astro-cid-jf5gi763>
        ...
        <select
            ...
            data-astro-cid-jf5gi763 multiple required
        >
        @foreach (\App\Models\CategoryMaster::all() as $Category)
...
<div data-astro-cid-jf5gi763 id="Flight_Row_` + flightCounter + `">
    ...
    <div class="flex flex-col gap-1 w-full" data-astro-cid-jf5gi763 id="">
        <div class="flex relative items-start gap-4" data-astro-cid-jf5gi763>
            ...
            `_lang_0" data-astro-cid-jf5gi763>`;
        lang.forEach(function(langItem, index) {
            flightContent += `
                 <option data-astro-cid-jf5gi763>` + langItem.language + `</option>`;
        });
...
<script>
    ...
    function deleteFlightConnection(FlightConnectionId) {
        Swal.fire({
            title: 'Are you sure?',
            ...
            if (result.isConfirmed) {
                ...
                $.ajax({
                    ...
                    data: {
                        flightconnectionId: FlightConnectionId,
                        "_token": "{{ csrf_token() }}"
                    },
