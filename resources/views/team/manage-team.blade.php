...
@section('main-container')
    <div class="ml-0 md:ml-[300px] mt-[55px] py-7 px-10 w-full" id="content" data-astro-cid-sckkx6r4>
        ...
        <div class="flex justify-between" data-astro-cid-rwhxyfax>
            <h1 class="text-4xl font-semibold">Manage Team</h1>
        </div>
        ...
        <div class="row">
            <div class="w-100 flex justify-between items-center">
                ...
                <div data-astro-cid-rwhxyfax>
                    <a role="button" type="submit" id="btn-new-team"
                        class="btn rounded-full bg-accent text-white no-animation mt-10" href="{{ route('Team.create') }}">
                        Create New Team
        ...
        <div class="justify-between mt-10" data-astro-cid-rwhxyfax>
            <h4 class="text-4xl font-semibold">Creative</h4>
        </div>
            ...
            @foreach ($Teams as $Team)
                @if ($Team->team_type == 'Creative')
                    <div class="flex items-center mb-6"> <!-- Adjust margin bottom for spacing -->
                        ...
                        <div class="w-12 h-12 flex items-center justify-center rounded-full bg-pink-500 text-white mr-4">
                        ...
                        <div class="relative">
                            ...
                            <div class="absolute right-0 mt-2 w-64 rounded-lg shadow-lg bg-white ring-1 ring-black ring-opacity-5 hidden"
                                ...
                                <div class="py-1" role="menu" aria-orientation="vertical"
                                    ...
                                    <div class="flex px-6 py-2 gap-3" style="z-index: 999">
        ...
        {{--        Clients --}}
        <div class="justify-between mt-10" data-astro-cid-rwhxyfax>
            <h4 class="text-4xl font-semibold">Clients</h4>
        </div>
        ...
        <div class="justify-between mt-10" data-astro-cid-rwhxyfax>
            <h4 class="text-4xl font-semibold">Media</h4>
        </div>


        <div class=" mt-5 max-w-lg mx-auto">
            @foreach ($Teams as $Team)
                @if ($Team->team_type == 'Media')
                    <div class="flex items-center mb-6"> <!-- Adjust margin bottom for spacing -->
                        <!-- Logo in circular fashion -->
                        <div class="w-12 h-12 flex items-center justify-center rounded-full bg-pink-500 text-white mr-4">
                            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 48 48" width="48px" height="48px">
