    ...
    <div class="ml-0 md:ml-[300px] mt-[55px] py-7 px-10 w-full" id="content" data-astro-cid-sckkx6r4>
        <div class="flex w-full flex-col gap-5" data-astro-cid-ujfssy6h>
            <div class="flex justify-between" data-astro-cid-ujfssy6h>
                ...
                <a href="{{ route('redirectsummery') }}" data-astro-cid-ujfssy6h>
                    <button
            ...
            <div class="flex visual-view-head justify-between" id="visual-view-head" data-astro-cid-ih4xnkm6>
                ...
                <div class="flex flex-col w-full gap-4" data-astro-cid-ih4xnkm6>
                    ...
                    {{-- @php
                        ...
                        $assetsStatusCount = AssetParameters::selectRaw(
                            'flight_connection_id, status, COUNT(*) as count',
                        )
                            ->groupBy('flight_connection_id', 'status')
                            ->get();
                    @endphp --}}
                    {{-- {{ dd($assetsStatusCount)}} --}}
                    @php
                        $statusCounts = \App\Models\AssetParameters::selectRaw('flight_id, status, COUNT(*) as count')
                            ->where('campaign_id', $id)
                            ->groupBy('flight_id', 'status')
                            ->get();
                    $groupedStatusCounts = $statusCounts->groupBy('flight_id');
                @endphp
                        <div class="flex flex-col gap-2" data-astro-cid-ih4xnkm6>
                            @foreach ($groupedStatusCounts as $flightId => $statuses)
                            @foreach ($statuses as $statusCount)
                                ...
                                <div class="flex gap-2 items-center" data-astro-cid-ih4xnkm6>
                                    ...
                                    <div class="w-full bg-gray-200 rounded-full h-6 relative" data-astro-cid-ih4xnkm6>
                                        <progress class="w-full h-full rounded-full" value="{{ $statusCount->count }}" max="10"
                            ...
                            @elseif ($statusCount->status == 'progress')
                                <div class="flex gap-2 items-center" data-astro-cid-ih4xnkm6>
                                    ...
                                    <div class="w-full bg-gray-200 rounded-full h-6 relative" data-astro-cid-ih4xnkm6>
                                        ...
                                        <div class="absolute top-0 left-0 h-full w-full rounded-full flex justify-between items-center px-3"
                                            data-astro-cid-ih4xnkm6>
                                            <img src="/assets/icons/emoji_objects.png" alt="create campaign"
                                                class="w-3" data-astro-cid-ih4xnkm6 />
                                                <p data-astro-cid-ih4xnkm6>{{ $statusCount->count }}</p>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="flex gap-2 items-center" data-astro-cid-ih4xnkm6>
                                    ...
                                    <div class="w-full bg-gray-200 rounded-full h-6 relative" data-astro-cid-ih4xnkm6>
                                        ...
                                        <div class="absolute top-0 left-0 h-full w-full rounded-full flex gap-10 items-center px-3"
                                            data-astro-cid-ih4xnkm6>
                                            <img src="/assets/icons/check_circle.png" alt="create campaign"
                                                class="w-3" data-astro-cid-ih4xnkm6 />
                                            <p data-astro-cid-ih4xnkm6>{{ $statusCount->count }}</p>
                                        </div>
                                    </div>
